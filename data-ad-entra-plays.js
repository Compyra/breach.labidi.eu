...
queries: [
    { label: 'RBCD configured on a computer object', lang: 'PowerShell · AD', q: '# Hyphenated attribute names must go through -LDAPFilter; the script-block\n# -Filter syntax parses "msDS-Allowed..." as a subtraction and fails.\nGet-ADComputer -LDAPFilter "(msDS-AllowedToActOnBehalfOfOtherIdentity=*)" `\n  -Properties msDS-AllowedToActOnBehalfOfOtherIdentity, whenChanged |\n  Select-Object Name, whenChanged,\n    @{n="AllowedToAct";e={\n        $sd = New-Object System.Security.AccessControl.RawSecurityDescriptor(\n                $_."msDS-AllowedToActOnBehalfOfOtherIdentity", 0)\n        ($sd.DiscretionaryAcl | ForEach-Object {\n           try { $_.SecurityIdentifier.Translate([System.Security.Principal.NTAccount]).Value }\n           catch { $_.SecurityIdentifier.Value }\n        }) -join "; " }}' },
